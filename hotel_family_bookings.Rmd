...
This is a walkthrough of the analysis I've completed with a sample dataset about hotel bookings given during the Google Data Analyst Certification. In this hypothetical scenario, the hotel is looking to increase profits by better understanding their profit data. The table used below, "hotel_bookings" is a newly created table that merged two of their previous tables together. 
